...
# Worksheets
## Weight: 20%
## Late policy: Drop two lowest scores

L01. Basics of Information:
    [pdf](worksheets/pdf/L01_worksheet.pdf)
    [docx](worksheets/information_worksheet.docx)

L02. The Digital Abstraction:
    [pdf](worksheets/pdf/L02_worksheet.pdf)
    [docx](worksheets/digital_worksheet.docx)

L03. CMOS Technology:
    [pdf](worksheets/pdf/L03_worksheet.pdf)
    [docx](worksheets/cmos_worksheet.docx)

L04. Combinational Logic:
    [pdf](worksheets/pdf/L04_worksheet.pdf)
    [docx](worksheets/combinational_worksheet.docx)

L05. Sequential Logic:
    [pdf](worksheets/pdf/L05_worksheet.pdf)
    [docx](worksheets/sequential_worksheet.docx)

L06. Finite State Machines:
    [pdf](worksheets/pdf/L06_worksheet.pdf)
    [docx](worksheets/fsm_worksheet.docx)

L07. Pipelined Circuits:
    [pdf](worksheets/pdf/L07_worksheet.pdf)
...
L11. Compilers:
    ...
    [docx](worksheets/compilation_answers.docx)

L12. Procedures and Stacks:
    [pdf](worksheets/pdf/L12_worksheet.pdf)
    [docx](worksheets/procedures_worksheet.docx)

L13. Building the Beta:
    [pdf](worksheets/pdf/L13_worksheet.pdf)
    [docx](worksheets/beta_worksheet.docx)

L14. Caches and the Memory Hierarchy:
    [pdf](worksheets/pdf/L14_worksheet.pdf)
    [docx](worksheets/caches_worksheet.docx)
    [docx](worksheets/cache_coherence_worksheet.docx)
    [docx](worksheets/cache_coherence_answers.docx)

L15. Pipelining the Beta:
    [pdf](worksheets/pdf/L15_worksheet.pdf)
    [docx](worksheets/pipelined_worksheet.docx)
    [docx](worksheets/pipelinedbeta_worksheet.docx)

L16. Virtual Memory:
    [pdf](worksheets/pdf/L16_worksheet.pdf)
    [docx](worksheets/vm_worksheet.docx)

L17. Virtualizing the Processor:
    [pdf](worksheets/pdf/L17_worksheet.pdf)
    [docx](worksheets/vm_worksheet.docx)

L18. Devices and Interrupts:
    [pdf](worksheets/pdf/L18_worksheet.pdf)
    [docx](worksheets/interrupts_worksheet.docx)

L19. Concurrency & Synchronization:
    [pdf](worksheets/pdf/L19_worksheet.pdf)
    [docx](worksheets/synchronization_worksheet.docx)
...
# Labs
## Weight: 70%
## Late policy: Asymptotic decay, 10% per day

Lab 1: CMOS Technology
    [html](labs/lab1_cmos/lab.html)

Lab 2: CMOS Adder
    [html](labs/lab2_adder/lab.html)

Lab 3: FSMs
    [html](labs/lab3_fsm/lab.html)

Lab 4: 32-bit ALU
    [html](labs/lab4_alu/lab.html)

Lab 5: Assembly Language
    [html](labs/lab5_assembly/lab.html)

Lab 6: Procedures & Stacks
    [html](labs/lab6_procedures/lab.html)

Lab 7: Building the Beta
    [html](labs/lab7_beta/lab.html)

Lab 8: Caches
    [html](labs/lab8_caches/lab.html)

Lab 9: Emulating Instructions
    [html](labs/lab9_illop/lab.html)

Lab 10: Tiny Operating System
    [html](labs/lab10_tinyos/lab.html)

Lab 11: Optimizing the Beta
    [html](labs/lab11_design_project/lab.html)
